...
import { useTranslation, usePreloadTranslations } from '@/contexts/SimpleTranslationContext';
...
const menuItems: MenuItem[] = [
  ...
  { name: 'Visits', href: '/visits', icon: Home },
  { name: 'Customers', href: '/customers', icon: Users },
  { name: 'Vehicles', href: '/vehicles', icon: Users },
  ...
  { name: 'Photo Report', href: '/photo-report', icon: Camera },
];
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-72 bg-white flex flex-col shadow-lg h-full">
      ...
      {/* Navigation Menu - RTL-FRIENDLY */}
      <nav className="flex-1 px-4 py-6 border-e border-primary-100">
        {/* Changed border-r to border-e (border-inline-end) */}
          ...
          {menuItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {isActive && (
                  <div className={`${isRTL ? 'mr-auto' : 'ml-auto'} w-1.5 h-1.5 rounded-full bg-white animate-pulse`} />
                )}
              </Link>
            );
          })}
      ...
      {/* Help Section - RTL-FRIENDLY */}
      <div className="p-4 border-t border-e border-primary-100 flex-shrink-0">
        {/* Changed border-r to border-e */}
          ...
          <div className="flex items-start gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600 leading-relaxed">
                {translate('Contact support for any issues or questions')}
              </p>
            </div>
          </div>
          <button 
